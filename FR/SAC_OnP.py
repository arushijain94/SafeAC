...
def run_agent(outputinfo, features, nepisodes,
              frozen_states, nfeatures, nactions, num_states, temperature, gamma_Q,
              gamma_var, lr_critic, lr_sigma, lr_theta, psi, rng, psi_fixed, psi_rate):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmbda', help='Bias-variance parameter', type=float, default=0.6)
    ...
    outer_dir = os.path.join(outer_dir, "FourRoomSAC")
    if not os.path.exists(outer_dir):
        os.makedirs(outer_dir)
