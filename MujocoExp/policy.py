...
class Policy(object):
    ...
    def _placeholders(self):
        ...
        self.advantages_var_ph = tf.placeholder(tf.float32, (None,), 'advantages_var')
        # strength of D_KL loss terms:
        self.beta_ph = tf.placeholder(tf.float32, (), 'beta')
        self.eta_ph = tf.placeholder(tf.float32, (), 'eta')
        # learning rate:
        self.lr_ph = tf.placeholder(tf.float32, (), 'eta')
        self.psi_ph = tf.placeholder(tf.float32, (), 'psi') # placeholder for regularizer on variance of return
    ...
    def _loss_train_op(self):
        ...
        """
        loss1 = -tf.reduce_mean((self.advantages_ph - self.psi_ph * self.advantages_var_ph)*
    ...
    def update(self, observes, actions, advantages, advantages_var, logger):
        ...
        Args:
            ...
            advantages_var: advantage function of variance, shape = (N,)
            logger: Logger object, see utils.py
        """
        feed_dict = {self.obs_ph: observes,
                     self.act_ph: actions,
                     self.advantages_ph: advantages,
                     self.advantages_var_ph: advantages_var,
                     self.beta_ph: self.beta,
                     self.eta_ph: self.eta,
                     self.lr_ph: self.lr * self.lr_multiplier,
                     self.psi_ph: self.psi}
